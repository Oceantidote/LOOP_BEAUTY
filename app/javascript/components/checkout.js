const initCheckout = () => {
  ...
  savedDeliveryAddresses.forEach(a => a.addEventListener('click', () => {
    ...
    deliveryAddressShow.innerHTML = `
                                      <p class="medium-text ls-xs mb-1">${a.dataset.user}</p>
                                      <p class="medium-text lighter ls-xs mb-1">${a.dataset.address_line1}</p>
                                      <p class="medium-text lighter ls-xs mb-1">${a.dataset.city}</p>
                                      <p class="medium-text lighter ls-xs mb-1">${a.dataset.country}</p>
                                      <p class="medium-text lighter ls-xs mb-1">${a.dataset.postcode}</p>
                                    `
