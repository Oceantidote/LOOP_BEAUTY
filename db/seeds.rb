...
# ariel = User.create!(published: true, influencer: false, first_name: "Ariel", last_name: "Roberts", gender: "Female", dob: date_of_birth, country: "Bristol, UK",password: "Ariel123", email: "ariel@gmail.com", accepts_terms: true)
# lenny = User.create!(published: true, influencer: false, first_name: "Leonard", last_name: "Percival", gender: "Male", dob: date_of_birth, country: "Oxford, UK",password: "Lenny123", email: "lenny@gmail.com", accepts_terms: true)
# ife = User.create!(published: true, influencer: false, first_name: "Ife", last_name: "Odugbesan", gender: "Male", dob: date_of_birth, country: "London, UK",password: "Ife123", email: "ife@gmail.com", accepts_terms: true)
# wrighty = User.create!(published: true, influencer: false, first_name: "Ben", last_name: "Wright", gender: "Male", dob: date_of_birth, country: "London, UK",password: "Wrighty123", email: "wrighty@gmail.com", accepts_terms: true)
...
# admin = User.create!(influencer: false, first_name: "contact", last_name: "hoxton", password: "Admin123", email: "admin@gmail.com", admin: true, accepts_terms: true)
...
# HomeBanner.destroy_all
# makeup = HomeBanner.create(link: "/make-up", display: true, text_color: "Black")
# ife.photo.attach(io: File.open('app/assets/images/ife.png'), filename: 'ife.png')

# makeup.banner.attach(io: File.open('makeup/mbanner.png'), filename: 'mbanner.png')
# makeup.mobile_banner.attach(io: File.open('makeup/mmobile_banner.png'), filename: 'mmobile_banner.png')

# makeup.iphone_se.attach(io: File.open('makeup/m320x568.jpg'), filename: 'm320x568.jpg')
# makeup.samsung_galaxy_s7.attach(io: File.open('makeup/m360x640.jpg'), filename: 'm360x640.jpg')
# makeup.samsung_galaxy_s9.attach(io: File.open('makeup/m360x740.jpg'), filename: 'm360x740.jpg')
# makeup.iphone_8.attach(io: File.open('makeup/m375x667.jpg'), filename: 'm375x667.jpg')
# makeup.iphone_11_pro.attach(io: File.open('makeup/m375x812.jpg'), filename: 'm375x812.jpg')
# makeup.nexus_6p.attach(io: File.open('makeup/m411x731.jpg'), filename: 'm411x731.jpg')
# makeup.iphone_8_plus.attach(io: File.open('makeup/m414x736.jpg'), filename: 'm414x736.jpg')
# makeup.iphone_11_pro_max.attach(io: File.open('makeup/m414x896.jpg'), filename: 'm414x896.jpg')
# makeup.google_pixel_2_xl.attach(io: File.open('makeup/m411x823.jpg'), filename: 'm411x823.jpg')
# makeup.samsung_galaxy_note_5.attach(io: File.open('makeup/m480x853.jpg'), filename: 'm480x853.jpg')
# makeup.nexus_7.attach(io: File.open('makeup/m600x960.jpg'), filename: 'm600x960.jpg')
# makeup.ipad_third__fourth_generation.attach(io: File.open('makeup/m768x1020.jpg'), filename: 'm768x1024.jpg')
# makeup.samsung_galaxy_tab_10.attach(io: File.open('makeup/m800x1280.jpg'), filename: 'm800x1280.jpg')
# makeup.ipad_pro.attach(io: File.open('makeup/m1024x1366.jpg'), filename: 'm1024x1366.jpg')
# makeup.chromebook_pixel.attach(io: File.open('makeup/m1280x850.jpg'), filename: 'm1280x850.jpg')


# insiders = HomeBanner.create(link: "/insider_articles/7", display: true, text_color: "White")

# influencers.banner.attach(io: File.open('influencers/inbanner.png'), filename: 'inbanner.png')
# influencers.mobile_banner.attach(io: File.open('influencers/inmobile_banner.png'), filename: 'inmobile_banner.png')

# insiders.iphone_se.attach(io: File.open('insiders/i320x568.jpg'), filename: 'i320x568.jpg')
# insiders.samsung_galaxy_s7.attach(io: File.open('insiders/i360x640.jpg'), filename: 'i360x640.jpg')
# insiders.samsung_galaxy_s9.attach(io: File.open('insiders/i360x740.jpg'), filename: 'i360x740.jpg')
# insiders.iphone_8.attach(io: File.open('insiders/i375x667.jpg'), filename: 'i375x667.jpg')
# insiders.iphone_11_pro.attach(io: File.open('insiders/i375x812.jpg'), filename: 'i375x812.jpg')
# insiders.nexus_6p.attach(io: File.open('insiders/i411x731.jpg'), filename: 'i411x731.jpg')
# insiders.iphone_8_plus.attach(io: File.open('insiders/i414x736.jpg'), filename: 'i414x736.jpg')
# insiders.iphone_11_pro_max.attach(io: File.open('insiders/i414x896.jpg'), filename: 'i414x896.jpg')
# insiders.google_pixel_2_xl.attach(io: File.open('insiders/i411x823.jpg'), filename: 'i411x823.jpg')
# insiders.samsung_galaxy_note_5.attach(io: File.open('insiders/i480x853.jpg'), filename: 'i480x853.jpg')
# insiders.nexus_7.attach(io: File.open('insiders/i600x960.jpg'), filename: 'i600x960.jpg')
# insiders.ipad_third__fourth_generation.attach(io: File.open('insiders/i768x1020.jpg'), filename: 'i768x1024.jpg')
# insiders.samsung_galaxy_tab_10.attach(io: File.open('insiders/i800x1280.jpg'), filename: 'i800x1280.jpg')
# insiders.ipad_pro.attach(io: File.open('insiders/i1024x1366.jpg'), filename: 'i1024x1366.jpg')
# insiders.chromebook_pixel.attach(io: File.open('insiders/i1280x850.jpg'), filename: 'i1280x850.jpg')

# influencers = HomeBanner.create(link: "/influencers", display: true, text_color: "Black")
# influencers.banner.attach(io: File.open('influencers/inbanner.png'), filename: 'inbanner.png')
# influencers.mobile_banner.attach(io: File.open('influencers/inmobile_banner.png'), filename: 'inmobile_banner.png')
# influencers.iphone_se.attach(io: File.open('influencers/in320x568.jpg'), filename: 'in320x568.jpg')
# influencers.samsung_galaxy_s7.attach(io: File.open('influencers/in360x640.jpg'), filename: 'in360x640.jpg')
# influencers.samsung_galaxy_s9.attach(io: File.open('influencers/in360x740.jpg'), filename: 'in360x740.jpg')
# influencers.iphone_8.attach(io: File.open('influencers/in375x667.jpg'), filename: 'in375x667.jpg')
# influencers.iphone_11_pro.attach(io: File.open('influencers/in375x812.jpg'), filename: 'in375x812.jpg')
# influencers.nexus_6p.attach(io: File.open('influencers/in411x731.jpg'), filename: 'in411x731.jpg')
# influencers.iphone_8_plus.attach(io: File.open('influencers/in414x736.jpg'), filename: 'in414x736.jpg')
# influencers.iphone_11_pro_max.attach(io: File.open('influencers/in414x896.jpg'), filename: 'in414x896.jpg')
# influencers.google_pixel_2_xl.attach(io: File.open('influencers/in411x823.jpg'), filename: 'in411x823.jpg')
# influencers.samsung_galaxy_note_5.attach(io: File.open('influencers/in480x853.jpg'), filename: 'in480x853.jpg')
# influencers.nexus_7.attach(io: File.open('influencers/in600x960.jpg'), filename: 'in600x960.jpg')
# influencers.ipad_third__fourth_generation.attach(io: File.open('influencers/in768x1024.jpg'), filename: 'in768x1024.jpg')
# influencers.samsung_galaxy_tab_10.attach(io: File.open('influencers/in800x1280.jpg'), filename: 'in800x1280.jpg')
# influencers.ipad_pro.attach(io: File.open('influencers/in1024x1366.jpg'), filename: 'in1024x1366.jpg')
# influencers.chromebook_pixel.attach(io: File.open('influencers/in1280x850.jpg'), filename: 'in1280x850.jpg')
